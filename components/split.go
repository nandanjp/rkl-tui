...
func newSplitView() SplitViewModel {
	m := SplitViewModel{
...
func (m *SplitViewModel) sizeInputs() {
	for i := range m.inputs {
...
func (m *SplitViewModel) updateKeybindings() {
...
func initSplitView() {
	if _, err := tea.NewProgram(newSplitView(), tea.WithAltScreen()).Run(); err != nil {
